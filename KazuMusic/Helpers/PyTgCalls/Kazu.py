...
from KazuMusic import BOT_NAME, app, db_mem, Ass
from KazuMusic.Helpers.PyTgCalls import Queues
from KazuMusic.Helpers.PyTgCalls.Converter import convert
from KazuMusic.Helpers.PyTgCalls.Downloader import download
from KazuMusic.Helpers.Database import remove_active_chat
from KazuMusic.Helpers.Thumbnails import thumb_init
from KazuMusic.Helpers.Inline import primary_markup
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) != "raw":
                ...
                if str(videoid) == "smex1":
                    ...
                    thumb = f"KazuMusic/Cache/{_path_}.jpg"
                    buttons = primary_markup(
                        videoid, "283402"
                    )
                finaltext = await app.send_photo(
