...
from KazuMusic.Helpers.Changers import *
from KazuMusic.Helpers.Clients import app, Ass
...
async def fallen_boot():
    ...
    with console.status(
        "[magenta] Booting Kazu Music Bot...",
    ) as status:
        console.print("┌ [red]Booting Kazu Music Clients...\n")
        await app.start()
        await Ass.start()
        console.print("└ [green]Clients Booted Successfully!")
        initial = await startup_msg("**» ʙᴏᴏᴛɪɴɢ ᴋᴀᴢᴜ ᴍᴜsɪᴄ ʙᴏᴛ...**")
