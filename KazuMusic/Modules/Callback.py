...
from KazuMusic.Cache.checker import checkerCB
...
from KazuMusic import BOT_USERNAME, BOT_NAME, app, db_mem
from KazuMusic.Helpers.Inline import (audio_markup, primary_markup, close_key)
from KazuMusic.Helpers.Database import (add_active_chat, is_active_chat, remove_active_chat, is_music_playing, music_off, music_on)
        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) != "raw":
                ...
                if str(videoid) == "smex1":
                    ...
                    thumb = f"KazuMusic/Cache/{_path_}final.png"
                    buttons = primary_markup(
                        videoid,
                        CallbackQuery.from_user.id,
                    )
