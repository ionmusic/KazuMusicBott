...
from KazuMusic import (ASSID, ASSMENTION, ASSNAME, ASSUSERNAME, BOT_ID, BOT_NAME, BOT_USERNAME, SUDO_USERS, F_OWNER, db, app, Ass)
...
async def fallen_boot():
    ...
    try:
        ...
        return
    try:
        await Ass.join_chat("KazuSupportGrp")
        await Ass.join_chat("KazuxProjects")
    except:
        pass
